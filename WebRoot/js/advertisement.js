...
document.write(unescape("%3Cscript src='http://static4.baihe.com/tongduntoken.js'  charset='utf-8'  type='text/javascript'%3E%3C/script%3E"));
*/
...
//--------空闲帮标准尾内容
var bzw_html = '';
bzw_html += '<div id="BHFooter" style="background-color:#ffc107;padding-bottom:10px;">';
bzw_html += '<div class="cont">';
bzw_html += '	<ul style="margin:0 auto;text-align:center;"">';
bzw_html += '		<li style="margin:0 auto; text-align:center;">';
bzw_html += '			<span style="text-align:center;"><a href="http://help.baihe.com/index.php?action=list&cat=568&listid=28#" target="_blank" onfocus="this.blur();">关于空闲帮</a> | <a href="http://help.baihe.com/index.php?action=list&cat=569&listid=28#" target="_blank" onfocus="this.blur();">商务合作</a> | <a href="http://help.baihe.com/index.php?action=list&cat=571&listid=28#" target="_blank" onfocus="this.blur();">联系我们</a> | <a href="http://help.baihe.com/index.php?action=list&cat=572&listid=28#" target="_blank" onfocus="this.blur();">诚聘人才</a> | <a href="http://help.baihe.com/" target="_blank" onfocus="this.blur();">帮助中心</a><a href="http://help.baihe.com/index.php?action=list&cat=573&listid=28#" target="_blank" onfocus="this.blur();">服务条款</a> | <a href="http://help.baihe.com/index.php?action=list&cat=574&listid=28#" target="_blank" onfocus="this.blur();">隐私保护</a> | <a href="http://safe.baihe.com" target="_blank" onfocus="this.blur();">交友安全</a> | <a href="javaScript:void(1)" onclick="openChat()"  onfocus="this.blur();">意见反馈</a> | <a href="http://www.baihe.com/sitemap.html" target="_blank">网站地图</a><a href="http://help.baihe.com/index.php?action=list&cat=633&listid=3" target="_blank" onfocus="this.blur();">家长监护工程</a> | <a href="http://music.baihe.com" target="_blank">空闲帮直播</a> | <a href="http://game.baihe.com" target="_blank">空闲帮游戏</a></span><BR />客服微信：baihekefu';
bzw_html += '		</li>';
bzw_html += '		<li style="margin:0 auto;text-align:center;padding:10px 0px;">';
bzw_html += '			<span>北京市朝阳区阜通东大街1号院望京SOHO 塔3 B座 6层(100102)<br />';
bzw_html += '           服务城市：<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">北京</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">上海</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">广州</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">深圳</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">天津</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">太原</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">成都</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">哈尔滨</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">大连</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">合肥</a>|';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">杭州</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">济南</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">南京</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">青岛</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">武汉</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">西安</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">郑州</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">石家庄</a> | ';
bzw_html += '			<a target="_blank" href="http://vip.baihe.com/?from=baihe&site=foot">更多</a>' ;
bzw_html += '			</span><br />';
bzw_html += '			违法和不良信息举报电话：0316-5266032（24小时）<br />';
bzw_html += '		</li>';
bzw_html += '	</ul>';
bzw_html += '	<div class="clear"></div>';
bzw_html += '	<p style="color:#333; font-family:Arial" ><a style="text-decoration: none;" href="http://www.miibeian.gov.cn" target="_blank">京ICP备10009806号-1</a>　　京公网安备110105000655号　　京ICP证041124号　　京网文（2016）6588-901号　　版权所有&copy; 2005 - '+new Date().getFullYear()+' 空闲帮网<br />';
bzw_html += '	<a target="_blank" href="http://media.baihe.com/index.php?action-viewnews-itemid-771-php-1">广播电视节目制作经营许可证（京）字第01303号</a></p>';
bzw_html += '<hr style="width:80%;color:#fff;" />';
bzw_html += '</div>';
bzw_html += '</div>';
...
//document.write('<script type=\"text/javascript\" src=\"http://dl.ntalker.com/js/xn6/ntkfstat.js?siteid=kf_9847\" charset=\"utf-8\"></script>');
