            ...
            <div class="row" >
                <div class="col-md-12" style="height:300px;margin-top:50px;">
    				<div style="position:relative">
    					...
    					<div>
    						<span id="beeword1" class='beeimg'>&nbsp&nbsp方便<br>convienient</span>
    						<span id="beeword2" class='beeimg'>&nbsp&nbsp快捷<br>instant</span>
    						<span id="beeword3" class='beeimg'>&nbsp&nbsp高效<br>efficient</span>
    						<span id="beeword4" class='beeimg'>&nbsp&nbsp省心<br>assured</span>
    					</div>
