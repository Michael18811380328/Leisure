...
<%@ page language="java" import="java.util.*" import="com.dao.*" import="com.entity.*" pageEncoding="utf-8" contentType="text/html;charset=utf-8" %>
<%
            ...
            <div class="col-md-10 table-responsive" style="border:2px solid #666; background-color: #f7f7f7 ;padding:0 0 10px 0;">
                ...
                <div class="col-md-10 col-md-offset-1">
                	<div style="margin:0 auto;">
                		<img style="margin:0 auto;display:block;" src="${pageContext.request.contextPath}/<%= task1.getCheckphoto_f() %>" height="100"/> 
                ...
                <div class="col-md-12" style="padding-bottom: 20px">
                  <a href="${pageContext.request.contextPath}/User/userjudge.jsp?user_no=<%=task1.getUser_no()%>&judge_no=<%=task1.getExcuteperson()%>"><img src="${pageContext.request.contextPath}/images/comment橘色.png" style="position:absolute;right:150px; top:-80px;width:80px;height:80px;" alt=""/></a>
                    <div class="progress">
                ...
                <form action="${pageContext.request.contextPath}/Confirm_j?id=<%= task1.getNo() %>&status=daoda" method="post">
               ...
               <form action="${pageContext.request.contextPath}/Confirm_j?id=<%= task1.getNo() %>&status=wancheng" method="post">
                <div class="col-md-3">
